...
# ==========================================================================================================================
def main():
    #pathnpy=r'C:\Users\mreve\Desktop\final_solution\cols_640x480_test0h0.65.npy'
    #pathply=r'C:\Users\mreve\Desktop\final_solution\640x480_test0h0.65.ply'
    movement = Movement()
    ...
    for i, obj in enumerate(fp.objects):
        ...
        print('object'+str(i),obj.color, obj.globaly, obj.globalx, obj.globalz, angle, len(obj.area), sep='    ')
