...
class OperateCamera:
    ...
    def __init__(self, clipping_distance=2, resolution=0):
        """resolution = 0(1280x720), 1(640x480)
        """
    ...
    def catch_frame(self):
        ...
        return self.pcd, color_image, depth_image


    def catch_frame_without_pcd(self):
        #resolution = 0(1280x720), 1(640x480)
        print('Started catching realsence data; resolution mode ')
